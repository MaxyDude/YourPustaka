...
<head>
    ...
    <title>Kelola Kategori - YourPustaka Petugas</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="{{ asset('css/views/petugas/kelola_kategori.css') }}">
</head>
<body>
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="/petugas/categories" class="menu-item active">
            ...
            <div class="user-actions">
                <div class="user-info-dropdown" id="userInfoDropdown">
                    <div class="user-info-container">
                        ...
                        <div class="user-info">
                            <div class="user-name">Petugas Perpustakaan</div>
...
window.__VIEW_CONFIG = {
    'e1': @json(route('petugas.categories.store')),
    'e2': @json(route('petugas.reports.print', ['type' => 'categories'])),
    'e3': @json($categories ?? [])
};
</script>
<script src="{{ asset('js/views/petugas/kelola_kategori.js') }}"></script>
</body>
</html>

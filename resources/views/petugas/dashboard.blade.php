...
<head>
    ...
    <title>Petugas Panel - YourPustaka</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="{{ asset('css/views/petugas/dashboard.css') }}">
</head>
<body>
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="/petugas/dashboard" class="menu-item active">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr
                                    ...
                                    data-officer-name="{{ $loan->approver?->name ?? 'Petugas Perpustakaan' }}"
                    ...
                    <div style="background-color: #f8f9fa; padding: 15px; border-radius: 8px;">
                        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 15px;">
                            <div>
                                ...
                                <p style="font-weight: 600;" id="officerName">Petugas Perpustakaan</p>
                            </div>
                            <div>
    ...
    <div id="userModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 id="userModalTitle">Tambah Pengguna Baru</h2>
...
window.__VIEW_CONFIG = {
    'e1': @json(route('petugas.categories.json')),
    'e2': @json(route('petugas.reports.print', ['type' => 'books'])),
    'e3': @json(route('petugas.reports.print', ['type' => 'loans'])),
    'e4': @json(route('petugas.reports.print', ['type' => 'users']))
};
</script>
<script src="{{ asset('js/views/petugas/dashboard.js') }}"></script>

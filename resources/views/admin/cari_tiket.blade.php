...
<head>
    ...
    <title>Verifikasi Tiket - Admin Panel - YourPustaka</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <!-- Library untuk QR Code Scanner -->
    <script src="https://unpkg.com/html5-qrcode@2.3.8/html5-qrcode.min.js"></script>
    <link rel="stylesheet" href="{{ asset('css/views/admin/cari_tiket.css') }}">
</head>
<body>
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="/admin/cari-tiket" class="menu-item active">
        ...
        <div class="content-area">
            ...
            <div class="verification-card">
                ...
                <div class="tab-content" id="manualTab">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="adminPin">PIN Admin (Opsional)</label>
...
<script src="{{ asset('js/views/admin/cari_tiket.js') }}"></script>
</body>
</html>

...
<head>
    ...
    <title>Kelola Ulasan - YourPustaka Admin</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="{{ asset('css/views/admin/kelola_ulasan.css') }}">
</head>
<body>
<div class="sidebar">
    ...
    <div class="sidebar-menu">
        ...
        <a href="/admin/kelola-ulasan" class="menu-item active">
...
<div class="main-content">
    ...
    <div class="content-area">
        <div class="page-header">
            ...
            <button class="btn btn-primary btn-sm" onclick="printReviewReport()">
...
window.__VIEW_CONFIG = {
    'e1': @json(route('admin.reports.print', ['type' => 'reviews']))
};
</script>
<script src="{{ asset('js/views/admin/kelola_ulasan.js') }}"></script>
</body>
</html>

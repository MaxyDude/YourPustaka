// Initialize tab indicator
        ...
        function viewBorrowDetail(button) {
            ...
            const officerName = row.dataset.officerName || 'Petugas Perpustakaan';
        ...
        function confirmReturnFromRow(row) {
            ...
            showPopup(`Konfirmasi pengembalian untuk peminjaman ID: ${borrowId}?`, 'info', 'Konfirmasi', () => {
                ...
                showPopup('Pengembalian berhasil dikonfirmasi!', 'success', 'Berhasil');
        ...
        function openUserModal(action, button = null) {
            ...
            if (action === 'add') {
                ...
                document.getElementById('userId').value = Math.floor(Math.random() * 9000) + 1000;
                // Set default role to "Peminjam"
                document.getElementById('userRole').value = 'Peminjam';
                ...
                if (cells.length >= 5) {
                    ...
                    document.getElementById('userRole').value = cells[4].textContent;
        ...
        function saveUser() {
            ...
            if (!userName || !userEmail || !userId || !userPhone || !userRole) {
                showPopup('Harap isi semua field yang wajib diisi!', 'warning', 'Validasi Error');
                return;
            }
            ...
            if (isEdit) {
                showPopup(`Data pengguna "${userName}" (ID: ${userId}) berhasil diperbarui!`, 'success', 'Diperbarui');
            } else {
                showPopup(`Pengguna "${userName}" (ID: ${userId}) berhasil ditambahkan!`, 'success', 'Ditambahkan');
            }
